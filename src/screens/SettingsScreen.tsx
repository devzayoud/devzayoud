  ...
  const settingsItems = [
    {
      ...
      icon: 'child-care',
      value: state.settings.parentalControl.enabled ? 'Enabled' : 'Disabled',
      onPress: () => navigation.navigate('ParentalControl'),
    },
    {
      id: 'playlists',
      label: 'Manage Playlists',
      icon: 'playlist-play',
      value: `${state.playlists.length} playlists`,
    ...
    },
    {
      ...
      onPress: () => Alert.alert('Player Settings', 'Feature coming soon'),
    },
    {
      id: 'streamFormat',
      label: 'Stream Format',
